...
public class BeerControllerTest {
    ...
    void whenPATCHIsCalledToIncrementGreatherThanMaxThenBadRequestStatusIsReturned() throws Exception {
        ...
        when(beerService.increment(VALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(new BeerStockExceededException(VALID_BEER_ID, quantityDTO.getQuantity()));
    ...
    void whenPATCHIsCalledToDecrementLowerThanZeroThenBadRequestStatusIsReturned() throws Exception {
        ...
        when(beerService.decrement(VALID_BEER_ID, quantityDTO.getQuantity())).thenThrow(new BeerStockExceededException(VALID_BEER_ID, quantityDTO.getQuantity(), true));
